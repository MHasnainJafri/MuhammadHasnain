  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 bg-background text-foreground">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        ...
        Senior Software Engineer, Full Stack Laravel Developer, and System Architect specializing in scalable web applications, API engineering, and DevOps integration
        </p>
        ...
        <div className="flex gap-4">
          {[
  { icon: Github, href: "https://github.com/MHasnainJafri" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/mhasnainjafri" },
  { icon: Mail, href: "mailto:mhasnainjafri51214@gmail.com" },
].map((social, index) => (
