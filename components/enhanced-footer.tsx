      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            >
              <div className="font-bold text-xl mb-4">Muhammad Hasnain</div>
<p className="text-muted-foreground mb-6">
  Full Stack Laravel Developer & Software Engineer specializing in building scalable web applications, microservices architecture, and performance optimization.
</p>

<div className="flex gap-3">
  <SocialButton
    icon={<Github className="h-5 w-5" />}
    url="https://github.com/MHasnainJafri"
    label="GitHub"
  />
  <SocialButton
    icon={<Linkedin className="h-5 w-5" />}
    url="https://www.linkedin.com/in/mhasnainjafri"
    label="LinkedIn"
  />
  {/* Remove Twitter or add a placeholder if needed */}
  {/* <SocialButton icon={<Twitter className="h-5 w-5" />} url="https://twitter.com" label="Twitter" /> */}
  <SocialButton
    icon={<Mail className="h-5 w-5" />}
    url="mailto:mhasnainjafri51214@gmail.com"
    label="Email"
  />
</div>
            </motion.div>
...
<ul className="space-y-3">
  <li className="flex items-center gap-3 text-muted-foreground">
    ...
    <span>mhasnainjafri51214@gmail.com</span>
  </li>
  <li className="flex items-center gap-3 text-muted-foreground">
    <Phone className="h-4 w-4 text-primary" />
    <span>+92 344 6800893</span>
  </li>
  <li className="flex items-center gap-3 text-muted-foreground">
    ...
    <span>Available for projects</span>
        ...
        <div className="border-t pt-6 flex flex-col md:flex-row justify-between items-center">
          <div className="text-sm text-muted-foreground mb-4 md:mb-0">
            © {currentYear} Muhammad Hasnain. All rights reserved.
          </div>
