...
export default function RedesignedHero() {
  ...
  const handleContactClick = () => {
    toast({
      title: "Contact Info",
      description: "Email: mhasnainjafri51214@gmail.com | Phone: (917) 831-2482",
      duration: 5000,
    })
  }
  ...
  const fullText =
    "SSenior Software Engineer, Full Stack Laravel Developer, and System Architect specializing in scalable web applications, API engineering, and DevOps integration"
  ...
  const highlightText = (text: string) => {
    const termsToHighlight = ["Laravel", "React.js", "DevOps", "API Development", "PostgreSQL", "MySQL"];
          ...
          <ScrollReveal delay={0.5}>
            <div className="flex gap-4 justify-center md:justify-start">
              ...
              <Button
                ...
                className="rounded-full hover:bg-white/10 transition-all duration-300 hover:scale-110"
              >
                <a href="mailto:mhasnainjafri51214@gmail.com" aria-label="Email">
