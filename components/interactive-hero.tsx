    ...
    <CustomGradientBackground className="min-h-[90vh]">
      ...
      >
        ...
        <div className="container mx-auto px-4 z-10">
          ...
          >
            <SocialButton icon={<Github className="h-5 w-5" />} url="https://github.com/MHasnainJafri" label="GitHub" />
            <SocialButton icon={<Linkedin className="h-5 w-5" />} url="https://www.linkedin.com/in/mhasnainjafri" label="LinkedIn" />
          </motion.div>
        </div>
